...
DELIMITER //
CREATE TRIGGER auditoria_preco 
AFTER UPDATE 
...
## Pessoas atualmente deletadas

DELIMITER //
CREATE TRIGGER pessoas_deletadas
BEFORE DELETE 
...
DELETE FROM pessoa WHERE id_pessoa = 6;
SELECT * FROM pesoas_deletadas;

SELECT * FROM cliente WHERE id_pessoa = 6;

DELETE FROM cliente  WHERE id_pessoa = 6;
...
VALUES
('Rafael', '000.000.000-00', '(00) 0 0000-0000 ', 'Rafael@gmail.com'),
...
('Pedro Costa', '946.186.014-81', '(23) 95629-8560', 'PedroCosta@email.com');
...
VALUES
('São Paulo', 'Rua das flores', 'Vila Mariana', '00000-00', 'SP', '1'),
...
VALUES
('2025-05-10 00:00:00', 150.75, 10.0, 5.0 , 2025, 1, 2, 1),
('2025-05-12 00:00:00', 230.50, 05.0, 10.0, 5   , 2, 3, 1),
('2025-05-13 00:00:00', 99.99 , 0   , 7.5 , 10  , 2, 4, 3),
('2025-05-14 00:00:00', 450.00, 20.0, 15.0, 20  , 1, 2, 2),
('2025-05-15 00:00:00', 320.00, 10.0, 0   , 10  , 2, 2, 4);
...
VALUES
('7.46' , '0'    , '5' , (SELECT preco FROM produto WHERE id_produto = 5), (quantidade*preco)-desconto + acrescimo, 2, 5),
...
iv.preco, 
iv.valor_total, 
p.quantidade_estoque  FROM itens_venda iv
...
INNER JOIN pessoa pv ON pv.id_pessoa = v.id_pessoa
