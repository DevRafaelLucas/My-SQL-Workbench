...
##Valores(dados)
VALUES('Rafael-Negocios', '000.000.000-00', 'R', '(00) 0 0000-0000', 'Rafael@gmail.com', 'A'), 
...
CREATE VIEW SomaValorObraProjeto AS

SELECT pj.nomeProjeto,
pj.valorProjeto,
o.valorObra,
(pj.valorProjeto + o.valorObra) AS ValorObraProjeto
FROM obra o
