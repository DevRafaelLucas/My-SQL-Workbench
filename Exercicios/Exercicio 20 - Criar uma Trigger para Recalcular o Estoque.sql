...
BEGIN
UPDATE venda SET valor_total = ((OLD.valor_total - NEW.valor_total) + (OLD.valor_total)) WHERE id_venda = NEW.id_venda;
END //
...
VALUES
(150.75, 10.0, 5.0 , 2025, 1, 2, 1),
(230.50, 05.0, 10.0, 5   , 2, 3, 1),
(99.99 , 0   , 7.5 , 10  , 2, 4, 3),
(450.00, 20.0, 15.0, 20  , 1, 2, 2),
(320.00, 10.0, 0   , 10  , 2, 2, 4);
