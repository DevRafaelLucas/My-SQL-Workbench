...
CREATE VIEW consultaPacienteMedico AS

SELECT cs.dataConsulta,
md.situacao, 
md.id_medico AS Medico, 
md.especialidade, 
cs.id_paciente AS Paciente, 
pc.planoSaude, 
pc.codigoCarteirinha FROM consulta cs
INNER JOIN medico md ON md.id_medico = cs.id_medico
INNER JOIN paciente pc ON pc.id_paciente = cs.id_paciente;

SELECT * FROM consultaPacienteMedico;