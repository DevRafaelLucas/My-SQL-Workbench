...
VALUES('2025-05-10', 150.75, 10.0, 5.0, '2025', 4, 5, 1),
('2025-05-12', 230.50, 5.0, 10.0, '5', 2, 3, 1),
('2025-05-13', 99.99, 0.0, 7.5, '10', 3, 1, 3),
('2025-05-14', 450.00, 20.0, 15.0, '20', 5, 2, 2),
('2025-05-15', 320.00, 10.0, 0.0, '10', 1, 4, 4);
...
('12.24', '10.00', '10', (SELECT preco FROM produto WHERE id_produto = 3), ((quantidade*preco)-desconto + acrescimo), 7, 3),
